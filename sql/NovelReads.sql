-- Creates framework for the library's entire database.
CREATE DATABASE IF NOT EXISTS `NovelReads`;

-- Creates a table for user login/registration
...
-- Creates a table with available genres.
...
-- Creates an empty table where information on rented books will be stored.
...
-- Initializes with 20 books of various genres.
